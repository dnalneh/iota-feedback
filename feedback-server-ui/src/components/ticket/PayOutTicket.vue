<template>
  <div>
    ...
    <h2 class="mb-3">Payout ticket</h2>
    ...
    <form @submit.prevent="validateBeforeSubmit" novalidate class="myclear" v-if="showContent">
      ...
      <b-row class="mb-4">
        <b-col>
          <div class="form-group mb-3">
            <label for="exampleInput2">Amount MIOTA:</label>                    
                ...
                this.helper.common.showModalMessage(
                  {
                    header: "Error",
                    subheader: "",
                    text: "The payment for this ticket is already done."
                  },
                  () => {
                    this.helper.common.goTo("viewticket", true);
                  }
                );
              } else {
                this.loadUserData();
            ...
            this.iota.api.getAccountData(
              ...
              (e, accountData) => {
                if (e) {
                  ...
                  this.iotaData.walletAmountEur = this.round(
                    this.iotaData.currentPriceEur * this.iotaData.walletAmount,
                    2
                  );
                }
              }
